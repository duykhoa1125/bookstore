  ...
  return (
    <div className="max-w-[1600px] mx-auto p-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-gray-900">Manage Publishers</h1>
          <p className="text-gray-500 mt-1 font-medium">Create, edit, and archive publishers.</p>
        </div>
        <button
          onClick={() => {
            setShowCreateModal(true)
        ...
        >
          ...
          <span className="font-semibold">Add Publisher</span>
        </button>
      </div>
          ...
          <div className="overflow-x-auto">
                  ...
                  <tr key={publisher.id} className="hover:bg-blue-50/30 transition-colors group">
                    <td className="px-8 py-5 whitespace-nowrap">
                      <div className="flex items-center">
                        <div className="w-10 h-10 rounded-full bg-cyan-50 border border-cyan-100 flex items-center justify-center mr-4 shadow-sm group-hover:scale-105 transition-transform">
                          <Building2 className="w-5 h-5 text-cyan-600" />
                        </div>
                        <span className="text-sm font-bold text-gray-900">{publisher.name}</span>
                      </div>
                    </td>
            ...
            {publishers.length === 0 && (
              <div className="flex flex-col items-center justify-center py-16 text-gray-500">
                ...
                <p className="text-lg font-medium text-gray-400">No publishers found</p>
              </div>
            )}
          </div>
        </div>
